...
export const Navbar = () => {
    ...
    const menuItems = ['Home', 'Features', 'Pricing', 'Process', 'Contact'];
        ...
        <nav className={`fixed w-full top-0 z-50 transition-all duration-300 ${scrolled ? 'nav-blur py-4' : 'bg-transparent py-6'}`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between">
                    ...
                    <button className="hidden md:block gradient-bg text-white px-6 py-2.5 rounded-lg font-semibold btn-glow">
                        Get Started
                    </button>
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden mt-4 glass-card rounded-lg p-4 fade-in">
                        ...
                        <button className="w-full gradient-bg text-white px-6 py-2.5 rounded-lg font-semibold mt-4">
                            Get Started
                        </button>
                    </div>
                )}
