...
export const PurchasePlanContact = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch(`${API_BASE_URL}/purchage/save_purchase.php`, {
        method: "POST",
      ...
      console.log("save_purchase raw response:", raw);
      ...
      setSuccessMsg(
        "Thank you! Your purchase inquiry has been received. We will contact you soon."
      );
      setFormData({
        name: "",
        email: "",
      ...
      console.error("Purchase contact submit error:", err);
      setErrorMsg(
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="12 Months" className="text-black">
                    12 Months
                  </option>
                </select>
              </div>
